...
namespace TimChu
{
    public partial class Computer : Form
    {
        ...
        int dem = 0;
        string[] txt = { "sllec","nmuloc","tnemucod","daolnwod","redaeh","egapemoh","tenretni","rotinom",
        "enilno","tuptuo","rossecorp","erotser","tceles","revres","egapbew","piz"};
        string[] s = {"cells","column","document","download","header","homepage","internet","monitor",
            "online","output","processor","restore","select","server","webpage","zip"};
                ...
                if (String.Compare(txt1.Text, s[i], true) == 0 || String.Compare(txt1.Text, txt[i], true) == 0)
                {
                    switch (i)
                    {
                        ...
                        case 11:
                            ...
                            btn65.BackColor = Color.DeepPink;
                            btn76.BackColor = Color.DeepPink;
                            btn87.BackColor = Color.DeepPink;
                            dem++;
                            break;
                        case 12:
