...
namespace TimChu
{
    public partial class Country : Form
    {
        ...
        int dem = 0;
        string[] txt = {"acirfa","anitnegra","adanac","ecnarf","alametaug","itiah","ylati","napaj","aybil",
        "lagutrop","ainamor","niaps","ogot","aisinut","yekrut","manteiv"};
        string[] s = {"africa","argentina","canada","france","guatemala","haiti","italy","japan","libya",
        "portugal","romania","spain","togo","tunisia","turkey","vietnam"};
                ...
                if (String.Compare(txt1.Text, s[i], true) == 0 || String.Compare(txt1.Text, txt[i], true) == 0)
                {
                    switch (i)
                    {
                        ...
                        case 2:
                            ...
                            btn29.BackColor = Color.DeepPink;
                        ...
                        case 6:
                            ...
                            btn100.BackColor = Color.DeepPink;
                        ...
                        case 7:
                            ...
                            btn14.BackColor = Color.DeepPink;
                            btn15.BackColor = Color.DeepPink;
                            dem++;
                            break;
                        case 8:
                        ...
                        case 9:
                            ...
                            btn91.BackColor = Color.DeepPink;
                            btn81.BackColor = Color.DeepPink;
                            btn71.BackColor = Color.DeepPink;
                            btn61.BackColor = Color.DeepPink;
                            btn51.BackColor = Color.DeepPink;
                            btn41.BackColor = Color.DeepPink;
        ...
        private void Country_KeyDown(object sender, KeyEventArgs e)
        {
